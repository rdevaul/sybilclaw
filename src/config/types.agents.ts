...
export type AgentConfig = {
  ...
  /** Optional allowlist of skills for this agent; omitting it inherits agents.defaults.skills when set, and an explicit list replaces defaults instead of merging. Can also be an AgentSkillsConfig object with allow/deny/noDefaults. */
