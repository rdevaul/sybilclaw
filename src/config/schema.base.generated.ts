...
export const GENERATED_BASE_CONFIG_SCHEMA = {
  ...
  uiHints: {
    ...
    "agents.defaults.memorySearch.store.path": {
      ...
      help: "Sets where the SQLite memory index is stored on disk for each agent. Keep the default `~/.sybilclaw/memory/{agentId}.sqlite` unless you need custom storage placement or backup policy alignment.",
      tags: ["storage"],
    },
