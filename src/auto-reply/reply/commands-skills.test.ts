...
const filterWorkspaceSkillEntriesWithOptionsMock = vi.hoisted(() => vi.fn());
...
vi.mock("../../skills/loading/workspace.js", () => ({
  ...
  filterWorkspaceSkillEntriesWithOptions: filterWorkspaceSkillEntriesWithOptionsMock,
}));
...
beforeEach(() => {
  ...
  // filterWorkspaceSkillEntriesWithOptions is called with (entries, { config }); pass through.
  filterWorkspaceSkillEntriesWithOptionsMock.mockImplementation((entries: unknown) => entries);
